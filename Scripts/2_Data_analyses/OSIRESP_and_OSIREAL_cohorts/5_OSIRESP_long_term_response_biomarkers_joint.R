...
# with osimertinib resistance. Tumor and stroma compartment (joint analysis).
...
model_data_tumor$long_response |> table(useNA = "always")
...
model_data_stroma$long_response |> table(useNA = "always")
...
save.image(file = "./Results/Intermediate/OSIRESP_and_OSIREAL_cohorts/5_OSIRESP_long_term_response_biomarkers_joint.RData")