...
# with osimertinib resistance. Stroma compartment.

# NOTES ----
# 1-
# This script was run on a workstation using multiple cores (parallelization)
...
save.image(file = "./Results/Intermediate/OSIRESP_and_OSIREAL_cohorts/4_OSIRESP_long_term_response_biomarkers_stroma.RData")
