...
model_data_final <- model_data |>
  select(
    -patient_id,-pfs_time_months,-disease_progression_to_osimertinib,-ecog_ps_dummie,-egfr_mutation_type
  )
...
# List with results ----
spatial_rf_list <- list(spatial_rf = spatial_rf, spatial_rf_oob = spatial_rf_oob)

saveRDS(spatial_rf_list, file = "./Results/Intermediate/OSIRESP_and_OSIREAL_cohorts/6_OSIRESP_long_term_response_signature_spatial.rds")
...
saveRDS(pseudobulk_rf, file = "./Results/Intermediate/OSIRESP_and_OSIREAL_cohorts/6_OSIRESP_long_term_response_signature_pseudobulk.rds")
