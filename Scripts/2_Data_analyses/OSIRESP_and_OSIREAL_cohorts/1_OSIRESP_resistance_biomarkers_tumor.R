...
# FUNCTIONS ----
source("./Scripts/Data_analyses/OSIRESP_cohort/ENET_cox_functions.R")
...
save.image(file = "./Results/Intermediate/OSIRESP_and_OSIREAL_cohorts/1_OSIRESP_resistance_biomarkers_tumor.RData")
