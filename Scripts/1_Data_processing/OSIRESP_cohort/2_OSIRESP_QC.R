...
rawdata <- readRDS("./Data/OSIRESP_cohort/Processed/OSIRESP_NSGeoMxSet_rawdata.rds")
...
saveRDS(neg_probes,
        "./Data/OSIRESP_cohort/Processed/OSIRESP_QC_negative_probes.rds")
...
# SAVE RESULTS ----
saveRDS(target_data,
        "./Data/OSIRESP_cohort/Processed/OSIRESP_QC.rds")
