...
target_data <- readRDS("./Data/OSIRESP_cohort/Processed/OSIRESP_QC.rds")
dim(target_data)
...
# ADD NORMALIZATION TO GEOMXSET OBJECT ----
...
saveRDS(target_data,
        "./Data/OSIRESP_cohort/Processed/OSIRESP_q3norm.rds")

# Only phenoData
pData <- pData(target_data)
pData |> class()
saveRDS(pData,
        "./Data/OSIRESP_cohort/Processed/OSIRESP_q3norm_pData.rds")
