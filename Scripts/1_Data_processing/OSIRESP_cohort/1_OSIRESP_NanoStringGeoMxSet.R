...
clinical_data <- read_xlsx("./Data/OSIRESP_cohort/Clinical_annotations/OSIRESP_clinical_annotations.xlsx")
...
labws <- readRDS("./Data/OSIRESP_cohort/Raw/OSIRESP_labworksheet.rds")
...
write.xlsx(labws,
           "./Data/OSIRESP_cohort/Processed/OSIRESP_labworksheet.xlsx")

# Path for the phenoData .xlsx file
pheno_data_dir <- "./Data/OSIRESP_cohort/Processed/OSIRESP_phenoData.xlsx"
...
# Labworksheet
saveRDS(labws, file = "./Data/OSIRESP_cohort/Processed/OSIRESP_labworksheet.rds")

# Raw data
saveRDS(rawdata, file = "./Data/OSIRESP_cohort/Processed/OSIRESP_NSGeoMxSet_rawdata.rds")
