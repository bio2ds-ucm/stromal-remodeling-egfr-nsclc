...
# HCC2935 cell line: initial processing of RNA-sequencing data and metadata
...
# Subset metadataa for HCC2935
metadata <- metadata |>
  filter(`cell line:ch1` == "HCC2935")
...
saveRDS(list_data,
        "./Data/Cell_line_models/Persistence/GSE193258_HCC2935.rds")
