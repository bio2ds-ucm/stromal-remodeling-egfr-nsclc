...
# H1975 cell line: initial processing of RNA-sequencing data and metadata
...
# Subset metadata for H1975
metadata <- metadata |>
  filter(`cell line:ch1` == "H1975")
...
saveRDS(list_data,
        "./Data/Cell_line_models/Persistence/GSE193258_H1975.rds")
