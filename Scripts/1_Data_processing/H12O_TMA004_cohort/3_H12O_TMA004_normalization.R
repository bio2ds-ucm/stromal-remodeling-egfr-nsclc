...
target_data <- readRDS("./Data/H12O_TMA004_cohort/Processed/H12O_TMA004_QC.rds")
dim(target_data)
...
saveRDS(target_data,
        "./Data/H12O_TMA004_cohort/Processed/H12O_TMA004_q3norm.rds")

pData <- pData(target_data)
pData |> class()
saveRDS(pData,
        "./Data/H12O_TMA004_cohort/Processed/H12O_TMA004_q3norm_pData.rds")
