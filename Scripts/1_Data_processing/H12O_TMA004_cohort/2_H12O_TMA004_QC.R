...
rawdata <- readRDS("./Data/H12O_TMA004_cohort/Processed/H12O_TMA004_NSGeoMxSet_rawdata.rds")
...
# Same parameters used for OSIRESP and OSIREAL cohort, except for nuclei count
# Nuclei count threshold set to 0 after inspection of images on DSP platform
...
# **We decided not to apply this criterion to this cohort after carefully examining
# the images from the GeoMx DSP, since it led to the exclusion of segments with sufficient
# nuclei that were, however, not correctly identified.
...
saveRDS(
  neg_probes,
  "./Data/H12O_TMA004_cohort/Processed/H12O_TMA004_QC_negative_probes.rds"
)
...
# SAVE RESULTS ----
saveRDS(target_data,
        "./Data/H12O_TMA004_cohort/Processed/H12O_TMA004_QC.rds")
