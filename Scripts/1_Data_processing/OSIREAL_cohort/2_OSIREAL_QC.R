...
rawdata <- readRDS("./Data/OSIREAL_cohort/Processed/OSIREAL_NSGeoMxSet_rawdata.rds")
...
qc_params <- list(
  ...
  # 30, # Minimum sequencing saturation
  minNegativeCount = 5,
...
saveRDS(neg_probes,
        "./Data/OSIREAL_cohort/Processed/OSIREAL_QC_negative_probes.rds")
...
# Ddetermine the number of genes detected in each segment across the dataset
LOQ_mat <- c()
for (module in modules) {
...
# SAVE RESULTS ----
saveRDS(target_data,
        "./Data/OSIREAL_cohort/Processed/OSIREAL_QC.rds")
