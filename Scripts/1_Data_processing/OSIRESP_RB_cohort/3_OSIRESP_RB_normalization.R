...
target_data <- readRDS("./Data/OSIRESP_RB_cohort/Processed/OSIRESP_RB_QC.rds")
dim(target_data)
...
saveRDS(target_data,
        "./Data/OSIRESP_RB_cohort/Processed/OSIRESP_RB_q3norm.rds")

# Only phenoData
pData <- pData(target_data)
pData |> class()
saveRDS(pData,
        "./Data/OSIRESP_RB_cohort/Processed/OSIRESP_RB_q3norm_pData.rds")
